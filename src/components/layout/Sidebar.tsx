...
export function AppSidebar() {
                       ...
                       <TooltipTrigger asChild>
                           <NavLink 
                             ...
                             className={`font-body group relative flex items-center gap-3 transition-all duration-200 ${
                                collapsed ? 'py-2 justify-center' : 'px-4 py-2'
                             } ${
                               active 
  ...
  return (
    ...
    >
      <SidebarHeader className={`border-b border-[hsl(var(--sidebar-border))] ${collapsed ? 'py-4 flex justify-center' : 'px-6 py-6'}`} style={{ 
      ...
      <SidebarContent className={`py-2 ${collapsed ? 'flex flex-col items-center' : 'px-0'}`} style={{ backgroundColor: 'hsl(var(--fleet-sidebar-darker))' }}>
        <TooltipProvider>
          {isSuperAdmin ? (
        ...
        <div className={`${collapsed ? 'py-2 flex justify-center' : 'px-4 py-4'} border-t border-[hsl(var(--sidebar-border))]`}>
          {collapsed ? (
