                    ...
                    {collapsed ? (
                        ...
                        >
                         ...
                         <NavLink 
                          ...
                          className={`font-body group/nav-item relative flex items-center gap-3 transition-all duration-200 ${
                                 ...
                                 className={`text-xs font-medium px-1.5 py-0.5 rounded-md shadow-sm ${
                                   item.badgeVariant === "live"
                                     ...
                                     : active 
                                       ...
                                       : "bg-white/15 text-white/90 border-white/30 group-hover/nav-item:bg-white/25 group-hover/nav-item:text-white"
                                 }`}
                              >
                                {item.badge}
                              </Badge>
