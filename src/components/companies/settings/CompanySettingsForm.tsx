              ...
              <div className="mt-6">
                <LoadNumberPatternConfig
                  ...
                  onPatternSaved={(data) => {
                    setFormData(prev => ({ 
                      ...prev, 
                      load_number_pattern: data.pattern,
                      load_number_pattern_description: data.description,
                      load_number_pattern_explanation: data.explanation,
                      load_number_pattern_examples: data.examples
                    }));
                  }}
                />
              </div>
