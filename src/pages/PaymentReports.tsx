...
export default function PaymentReports() {
    ...
    if (filters.status !== 'all') {
      switch (filters.status) {
        ...
        case 'failed':
          ...
          break;
        case 'negative':
          matchesStatus = calc.net_payment < 0;
          break;
      }
    }
  ...
  const totalEarnings = filteredCalculations.reduce((sum, calc) => sum + calc.net_payment, 0);
  ...
  return (
    <>
                      ...
                      <div className="space-y-2 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-sm text-muted-foreground">
                          <span className="flex items-center gap-2 font-semibold text-foreground">
                            ...
                            {t('reports.net')} {formatCurrency(calculation.net_payment)}
                          </span>
      ...
      <MarkDriverPaidDialog
        ...
        netPayment={selectedForPayment ? selectedForPayment.net_payment : 0}
