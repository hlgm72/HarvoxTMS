...
BEGIN
  ...
  -- Get company_id from the driver_period_calculation
  ...
  IF operation_type = 'CREATE' THEN
    INSERT INTO fuel_expenses (
      ...
      (expense_data->>'transaction_date')::TIMESTAMP WITH TIME ZONE,
      ...
      NULLIF(expense_data->>'wex_reference_id', ''),
  ...
  ELSE
    UPDATE fuel_expenses SET
      ...
      transaction_date = (expense_data->>'transaction_date')::TIMESTAMP WITH TIME ZONE,
      ...
      wex_reference_id = NULLIF(expense_data->>'wex_reference_id', ''),
