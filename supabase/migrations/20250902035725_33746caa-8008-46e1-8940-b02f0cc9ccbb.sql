...
BEGIN
  ...
  IF week35_period_id IS NOT NULL THEN
    ...
    WHERE id = week35_period_id;
    
    GET DIAGNOSTICS deleted_periods = ROW_COUNT;
    RAISE LOG 'Week 35 period cleaned up successfully';
  ELSE
    RAISE LOG 'Week 35 period not found or already deleted';
  END IF;
END $$;