-- Fix generate_recurring_expenses_for_period function to use simple English titles
...
-- Fix restore_recurring_expense_to_period function to use simple English titles
