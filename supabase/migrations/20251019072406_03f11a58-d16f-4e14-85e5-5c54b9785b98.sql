-- ============================================================================
-- FIX FINAL: Corregir trigger para no referenciar is_active directamente
-- ============================================================================
...
DECLARE
  ...
  -- ✅ Capturar is_active en variables locales
  old_is_active BOOLEAN;
  new_is_active BOOLEAN;
BEGIN
  -- ✅ Asignar is_active a variables locales PRIMERO
