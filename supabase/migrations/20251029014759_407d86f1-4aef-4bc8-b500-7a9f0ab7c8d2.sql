-- ============================================================================
-- Actualizar UPDATE OTHER INCOME para permitir cambio de applied_to_role
-- ============================================================================
...
BEGIN
  ...
  -- ✅ 8. Actualizar other_income (incluyendo applied_to_role si se proporciona)
  UPDATE other_income
  SET
    user_id = COALESCE(new_user_id, user_id),
    applied_to_role = COALESCE(update_data->>'applied_to_role', applied_to_role),
