-- Aplicar corrección retroactiva para las cargas de Diosvani que no tienen deducciones automáticas (FIXED)
...
BEGIN
  ...
  LOOP
    ...
    IF FOUND THEN
      -- Obtener driver_period_calculation_id (FIX: especificar dpc.id)
