-- Corregir el cálculo de deducciones - las categorías son diferentes
...
BEGIN
  ...
  -- 🚨 CORRECCIÓN CRÍTICA: Incluir todas las categorías de deducción
  -- Calculate deductions (incluyendo percentage_deduction, fixed_deduction, etc.)
  SELECT 
  ...
  RAISE NOTICE 'Driver recalc - ID: %, Gross: %, Fuel: %, Deductions: %, Income: %, Net: %', 
    calculation_id, 
