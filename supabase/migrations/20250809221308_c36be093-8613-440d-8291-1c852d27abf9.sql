...
-- Load management - medium priority
CREATE INDEX IF NOT EXISTS idx_loads_broker_dispatcher_id ON public.loads(broker_dispatcher_id) WHERE broker_dispatcher_id IS NOT NULL;
