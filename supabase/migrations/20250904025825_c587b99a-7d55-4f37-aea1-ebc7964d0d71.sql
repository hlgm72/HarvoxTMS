-- Fix the format function issue in calculate_driver_payment_period
...
BEGIN
    ...
    -- PASO 8: Generar mensaje de alerta si hay balance negativo - FIXED: format function
    IF has_negative THEN
        alert_msg := 'Balance negativo: El conductor debe $' || ABS(calculated_net_payment)::text;
    END IF;
