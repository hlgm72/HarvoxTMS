-- ============================================================================
-- FIX: Capturar is_active antes del UPDATE para evitar conflictos
-- ============================================================================
...
DECLARE
  ...
  previous_is_active BOOLEAN; -- ✅ Variable para capturar is_active antes del UPDATE
BEGIN
  ...
  ELSE
    ...
    SELECT 
      *,
      is_active AS prev_is_active
    INTO history_record
    FROM expense_recurring_templates 
    WHERE id = template_id;
    
    previous_is_active := history_record.prev_is_active;
    ...
    -- ✅ Usar la variable local en lugar de referenciar la columna
