-- Actualizar la función RPC de fuel expenses para recalcular el payroll automáticamente
...
BEGIN
  ...
  -- ✅ NUEVO: Asegurar que existe el user_payroll para este driver y período
  ...
  -- ✅ NUEVO: Recalcular el payroll del driver para reflejar el nuevo gasto de combustible
  BEGIN
    PERFORM calculate_user_payment_period_with_validation(user_payroll_id);
    RAISE LOG 'create_or_update_fuel_expense: Successfully recalculated payroll % for driver %',
