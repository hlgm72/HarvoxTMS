-- Fix UPSERT to also update descriptions when editing loads
-- This ensures descriptions change from "Factoring deduction for load X" to "Factoring fees"
...
BEGIN
  ...
  IF result_load.driver_user_id IS NOT NULL THEN
    ...
    IF driver_period_calc_id IS NOT NULL THEN
      -- FACTORING DEDUCTION (UPSERT) - Now updates description too
      ...
      -- DISPATCHING DEDUCTION (UPSERT) - Now updates description too
      ...
      -- LEASING DEDUCTION (UPSERT) - Now updates description too
