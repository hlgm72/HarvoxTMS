-- ============================================================================
-- CORRECCIÓN: apply_recurring_expenses_to_user_payroll debe usar user_payroll.id
-- ============================================================================

CREATE OR REPLACE FUNCTION public.apply_recurring_expenses_to_user_payroll(
  target_user_id uuid,
  target_period_id uuid  -- Este es company_payment_period_id
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  -- ✅ CRÍTICO: Obtener el user_payroll.id correcto
  ...
  LOOP
    ...
    -- ✅ CRÍTICO: Usar user_payroll_id en lugar de target_period_id
    IF EXISTS (
    ...
    -- ✅ CRÍTICO: Crear con user_payroll_id
    INSERT INTO expense_instances (
      ...
      user_payroll_id,  -- ✅ Usar user_payroll_id
