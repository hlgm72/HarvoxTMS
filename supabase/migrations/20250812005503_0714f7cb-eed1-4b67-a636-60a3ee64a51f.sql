-- Corregir las funciones para usar 'user_id' en lugar de 'driver_user_id'
...
BEGIN
  ...
  IF leasing_expense_type_id IS NOT NULL THEN
    INSERT INTO expense_instances (
      payment_period_id,
      expense_type_id,
      user_id, -- CORREGIDO: user_id en lugar de driver_user_id
      amount,
      description,
      expense_date,
      status,
    ...
    ON CONFLICT (payment_period_id, expense_type_id, user_id) -- CORREGIDO
    DO UPDATE SET 
