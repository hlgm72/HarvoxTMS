-- Create the process_company_payment_period function
...
BEGIN
  ...
  -- Generate or update driver period calculations
  -- This will call the existing RPC to generate calculations
  SELECT * INTO result_data 
  FROM generate_company_payment_periods_with_calculations(target_company_id, current_user_id, NULL::DATE);
