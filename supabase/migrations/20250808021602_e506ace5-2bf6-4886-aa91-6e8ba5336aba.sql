-- Fix calculation to include loads with 'assigned' status in gross earnings calculation
...
BEGIN
  ...
  -- Fixed: Include loads with status 'assigned', 'in_transit', 'completed'
  -- ================================
  ...
  -- Return success result with detailed calculation info
  RETURN jsonb_build_object(
    'success', true,
    'message', 'Período calculado exitosamente',
