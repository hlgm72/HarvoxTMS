-- Función auxiliar para crear deducciones por porcentajes de una carga específica
-- Esta función garantiza que cada carga tenga sus deducciones individuales correctas
...
BEGIN
  ...
  RAISE LOG '✅ Completed percentage deductions for load % (Amount: $%, L:%%, F:%%, D:%%)', 
    load_number_param, load_amount_param, leasing_pct_param, factoring_pct_param, dispatching_pct_param;
