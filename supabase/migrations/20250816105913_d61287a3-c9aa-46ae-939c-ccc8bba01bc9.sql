-- Fix the recursion by first dropping the policy, then the functions
...
-- Create security definer functions that bypass RLS using PLPGSQL
...
-- Create a simple policy that uses these functions
