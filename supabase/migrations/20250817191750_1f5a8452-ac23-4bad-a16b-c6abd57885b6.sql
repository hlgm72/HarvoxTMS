-- Security Fix: Restrict Driver Personal Information Access (Part 2 - Fixed Views & Functions)
...
-- Views inherit security from underlying tables, so no need for separate RLS
