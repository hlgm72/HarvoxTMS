-- ============================================================================
-- FIX DEFINITIVO: Forzar recreación completa de la función RPC
-- ============================================================================

-- Eliminar la función existente
DROP FUNCTION IF EXISTS public.create_or_update_expense_template_with_validation(jsonb, uuid);

-- Recrear desde cero con is_active incluido
...
BEGIN
  ...
  ELSE
    ...
    -- ✅ CRÍTICO: Incluir TODOS los campos, especialmente is_active
