-- ============================================================================
-- Primero eliminar las versiones antiguas de la función
-- ============================================================================
DROP FUNCTION IF EXISTS public.update_other_income_with_validation(income_id UUID, income_data JSONB);
DROP FUNCTION IF EXISTS public.update_other_income_with_validation(update_data JSONB);

-- ============================================================================
-- Actualizar UPDATE OTHER INCOME para permitir cambio de usuario
-- ============================================================================
