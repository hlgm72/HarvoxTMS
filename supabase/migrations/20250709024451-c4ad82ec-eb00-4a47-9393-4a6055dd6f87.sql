...
-- Insert sample data
INSERT INTO public.profiles (user_id, first_name, last_name, phone) VALUES
  (gen_random_uuid(), 'Admin', 'Usuario', '(555) 123-4567'),
  (gen_random_uuid(), 'Juan', 'Pérez', '(555) 234-5678'),
  (gen_random_uuid(), 'María', 'González', '(555) 345-6789');