-- Fix simple_load_operation function to include internal_dispatcher_id field
...
BEGIN
  ...
  IF operation_type = 'CREATE' THEN
    INSERT INTO loads (
      load_number,
      driver_user_id,
      internal_dispatcher_id,  -- ✅ ADDED: Include internal_dispatcher_id
      total_amount,
      currency,
      ...
      NULLIF((load_data->>'internal_dispatcher_id'), '')::UUID,  -- ✅ ADDED: Process internal_dispatcher_id
  ...
  ELSE
    ...
    UPDATE loads SET
      ...
      internal_dispatcher_id = COALESCE(NULLIF((load_data->>'internal_dispatcher_id'), '')::UUID, internal_dispatcher_id),  -- ✅ ADDED: Update internal_dispatcher_id
