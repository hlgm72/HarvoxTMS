-- Remove problematic views and replace with secure RPC functions
...
-- Create RPC function for basic company data
...
-- Create RPC function for financial company data
