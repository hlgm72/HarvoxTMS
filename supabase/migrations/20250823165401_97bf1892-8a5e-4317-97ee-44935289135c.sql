-- Fix the ambiguous column reference in create_or_update_company_with_validation function
-- by renaming the parameter and properly qualifying column references
