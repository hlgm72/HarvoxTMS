-- Actualizar simple_load_operation_with_deductions para calcular automáticamente
    ...
    IF v_driver_user_id IS NOT NULL THEN
      ...
      IF v_factoring_amt > 0 THEN
        INSERT INTO expense_instances (
          ...
          v_driver_user_id,
          '1a3355f5-1a3b-49d6-89b4-acc7f259ebdb', -- factoring expense type
          v_factoring_amt,
          v_relevant_date,
      ...
      IF v_dispatching_amt > 0 THEN
        INSERT INTO expense_instances (
          ...
          v_driver_user_id,
          '9e5a38ae-8851-4a8c-9bc7-11ac32cb7b10', -- dispatching expense type
          v_dispatching_amt,
          v_relevant_date,
      ...
      IF v_leasing_amt > 0 THEN
        INSERT INTO expense_instances (
          ...
          v_driver_user_id,
          '28d59af7-c756-40bf-885e-fb995a744003', -- leasing expense type
          v_leasing_amt,
          v_relevant_date,
