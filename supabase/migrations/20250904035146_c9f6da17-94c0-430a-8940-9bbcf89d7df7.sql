-- Update percentage deduction descriptions to remove "from loads" text (fixed version)
...
BEGIN
    ...
    SELECT 
        ...
        cpp.period_end_date,
        cpp.id
    INTO driver_id, period_start_date, period_end_date, company_payment_period_id
    ...
    AND l.payment_period_id = company_payment_period_id
...
-- Update existing expense instances to have the new descriptions
UPDATE expense_instances 
SET description = 'Dispatching fees' 
WHERE description = 'Dispatching fees from loads';

UPDATE expense_instances 
SET description = 'Factoring fees' 
WHERE description = 'Factoring fees from loads';

UPDATE expense_instances 
SET description = 'Leasing fees' 
WHERE description = 'Leasing fees from loads';