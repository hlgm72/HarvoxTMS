-- Fix RLS policies for expense_instances table
...
-- Policy to allow users to view expense instances
...
-- Policy to allow users to insert expense instances - simplified logic
...
-- Policy to allow users to update expense instances
...
-- Policy to allow users to delete expense instances
