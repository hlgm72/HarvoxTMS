-- Update get_companies_financial_data to include load_number_pattern fields
...
BEGIN
  ...
  IF target_company_id IS NOT NULL THEN
    ...
    SELECT 
      ...
      c.load_number_pattern, c.load_number_pattern_description,
      c.load_number_pattern_explanation, c.load_number_pattern_examples
    FROM companies c
