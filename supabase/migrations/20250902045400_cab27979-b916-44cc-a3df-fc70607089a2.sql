-- Fix scheduled_time type casting issue in simple_load_operation_with_deductions
-- The database column expects time without time zone, but we're passing text
  ...
  IF array_length(stops_data, 1) > 0 THEN
    ...
    FOR stop_data IN SELECT unnest(stops_data) LOOP
      INSERT INTO load_stops (
        ...
        -- ✅ FIXED: Proper time casting with null handling
        CASE 
