-- ============================================================================
-- SOLUCIÓN FINAL: Desactivar RLS dentro de SECURITY DEFINER para evitar ambigüedad
-- ============================================================================
...
BEGIN
  ...
  -- Validar permisos manualmente (ya que vamos a desactivar RLS)
  IF NOT EXISTS (
  ...
  -- ✅ Desactivar RLS para evitar conflictos con is_active
  ...
  ELSE
    ...
    -- Registrar cambio de monto en historial
