...
BEGIN
  RAISE NOTICE '🔄 v4.6-FINAL: Iniciando recálculo para conductor % en período %', target_driver_user_id, target_period_id;
  ...
  -- 1. Calculate fuel expenses 🚨 THE KEY FIX
  ...
  SET 
    ...
    fuel_expenses = calculated_fuel_expenses,  -- 🚨 COMBUSTIBLE DESCONTADO
  ...
  RAISE NOTICE '🎉 ¡COMBUSTIBLE DESCONTADO! gross=%, fuel=%, deductions=%, other=%, net=%', 
