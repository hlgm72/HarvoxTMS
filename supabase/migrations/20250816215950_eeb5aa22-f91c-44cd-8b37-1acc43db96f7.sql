-- Critical Security Fix: Restrict sensitive company data access
-- Separate company data into basic and financial views with proper access control

-- Create a function to check if user can access sensitive company data
...
-- Create a function to log sensitive data access for audit purposes
...
-- Create RPC function for secure financial data access
...
-- Create RPC function for basic company info (safe for all company members)
