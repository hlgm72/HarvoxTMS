-- ============================================================================
-- 🔧 CORRECCIÓN: Resolver ambigüedad de columna total_deductions
-- ============================================================================
...
BEGIN
  -- Log de inicio
  RAISE NOTICE '🔄 v3.2-AMBIGUEDAD-FIJA: Iniciando recálculo para conductor % en período %', target_driver_user_id, target_period_id;
  ...
  -- Las cargas apuntan a driver_period_calculations.id en payment_period_id
  SELECT 
  ...
  -- Calcular otras deducciones (no porcentajes) - USAR ALIAS EXPLÍCITOS
  ...
  SET
    ...
    total_deductions = total_deductions,  -- usar variable local, no columna
  ...
  RAISE NOTICE '✅ v3.2-AMBIGUEDAD-FIJA: Recálculo completado correctamente para conductor %', target_driver_user_id;
...
EXCEPTION WHEN OTHERS THEN
  RAISE EXCEPTION 'ERROR_OPERATION_FAILED: Error en recálculo v3.2-AMBIGUEDAD-FIJA: %', SQLERRM;
END;
$$;