-- Performance optimizations - Create indexes normally since CONCURRENTLY doesn't work in transactions
...
CREATE INDEX IF NOT EXISTS idx_vehicle_positions_vehicle_datetime 
ON vehicle_positions (vehicle_id, date_time DESC);

CREATE INDEX IF NOT EXISTS idx_geotab_vehicle_positions_vehicle_datetime 
