-- Solucionar errores del linter de Supabase (versión corregida)
...
-- 3. Solucionar el índice duplicado eliminando el constraint
...
VALUES ('rls_performance_optimization', jsonb_build_object(
  ...
  'optimizations', jsonb_build_object(
    ...
    'duplicate_constraints_removed', ARRAY[
