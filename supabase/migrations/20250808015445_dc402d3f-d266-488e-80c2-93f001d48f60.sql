-- Fix ambiguous total_income variable in recalculate_payment_period_totals function
...
BEGIN
  ...
  RAISE NOTICE 'Recalculated period % - Gross: %, Fuel: %, Deductions: %, Other Income: %, Net: %', 
    period_id, loads_total, fuel_total, deductions_total, other_income_total, net_payment;
END;
$function$;