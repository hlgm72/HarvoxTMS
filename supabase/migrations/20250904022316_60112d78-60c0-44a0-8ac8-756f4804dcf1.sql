-- Fix remaining company_id references in simple_load_operation_with_deductions function
...
BEGIN
  ...
  SELECT DISTINCT ucr.company_id INTO target_payment_period_id
  ...
  target_payment_period_id := create_payment_period_if_needed(target_payment_period_id, target_load_date);
