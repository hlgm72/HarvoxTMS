-- Corregir calculate_user_payment_period_with_validation para que no dependa del estado de la carga
-- y use correctamente los payment_period_id
...
BEGIN
  ...
  -- ✅ CORREGIDO: Calcular total de combustible usando company_payment_period_id
