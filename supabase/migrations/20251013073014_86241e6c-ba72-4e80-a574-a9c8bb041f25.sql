-- Fix expense_instances foreign key issue in simple_load_operation_with_deductions
-- The payment_period_id in expense_instances should reference company_payment_periods.id, not user_payrolls.id
...
BEGIN
  ...
  IF v_relevant_date IS NOT NULL THEN
    ...
    IF v_driver_user_id IS NOT NULL THEN
      ...
      -- Insertar deducción por factoring si aplica (CORREGIDO: usar v_company_payment_period_id)
      ...
      -- Insertar deducción por dispatching si aplica (CORREGIDO: usar v_company_payment_period_id)
      ...
      -- Insertar deducción por leasing si aplica (CORREGIDO: usar v_company_payment_period_id)
