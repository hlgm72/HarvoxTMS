...
COMMENT ON VIEW views.profiles_ordered IS 'Vista ordenada lógicamente de driver_profiles: identificadores, info personal, licencia, contactos de emergencia, metadatos del sistema';