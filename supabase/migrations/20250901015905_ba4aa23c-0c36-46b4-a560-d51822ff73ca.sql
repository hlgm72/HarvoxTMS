-- Corregir error crítico en recalculate_driver_period_calculation
-- El problema: se compara payment_period_id con driver_calc.id en lugar de driver_calc.company_payment_period_id

DROP FUNCTION IF EXISTS public.recalculate_driver_period_calculation(uuid);
...
BEGIN
  ...
  -- 🚨 CORRECCIÓN CRÍTICA: Usar company_payment_period_id en lugar de driver_calc.id
  ...
  -- Log the successful recalculation
  RAISE NOTICE 'Driver calculation recalculated - ID: %, Gross: %, Net: %', 
    calculation_id, 
