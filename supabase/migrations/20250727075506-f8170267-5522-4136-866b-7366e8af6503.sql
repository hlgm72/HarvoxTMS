-- Arreglar la función generate_recurring_expenses_for_period con las columnas correctas

CREATE OR REPLACE FUNCTION public.generate_recurring_expenses_for_period(company_payment_period_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
