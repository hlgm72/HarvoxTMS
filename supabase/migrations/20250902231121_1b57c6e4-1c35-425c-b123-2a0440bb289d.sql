-- Fix ambiguous column reference in auto_recalculate_driver_payment_period_v2
...
BEGIN
  ...
  -- 2. Calculate LOADS income with explicit table aliases
  SELECT 
  ...
  -- 3. Calculate fuel expenses with explicit table aliases
