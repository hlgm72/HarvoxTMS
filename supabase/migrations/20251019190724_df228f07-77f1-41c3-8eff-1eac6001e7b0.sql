-- Corregir FK en trigger: expense_instances.payment_period_id debe ser company_payment_period_id
  ...
  WHILE v_period_date <= v_end_date LOOP
    ...
    BEGIN
      ...
      IF NOT EXISTS (
        ...
        -- ✅ CORRECCIÓN CRÍTICA: usar v_company_payment_period_id en lugar de v_user_payroll_id
