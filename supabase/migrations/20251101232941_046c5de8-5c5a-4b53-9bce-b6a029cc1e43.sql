-- Clean up function overloading issue for get_companies_basic_info
...
DROP FUNCTION IF EXISTS get_companies_basic_info(company_id_param uuid);
DROP FUNCTION IF EXISTS get_companies_basic_info(company_id_filter uuid);

-- Recreate only the version without parameters
