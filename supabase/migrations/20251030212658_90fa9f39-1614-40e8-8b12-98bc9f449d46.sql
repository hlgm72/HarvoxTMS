-- Corregir función simple_load_operation_with_deductions
-- Eliminar referencias a columnas inexistentes: customer_name y company_id
...
BEGIN
  ...
  -- ========================================
  IF v_is_update THEN
    -- UPDATE: Actualizar carga existente (SIN customer_name)
    UPDATE loads SET
  ...
  ELSE
    -- CREATE: Insertar nueva carga (SIN customer_name ni company_id)
    INSERT INTO loads (
