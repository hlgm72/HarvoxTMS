-- Corregir función simple_load_operation_with_deductions para usar la función correcta
-- El problema es que está llamando a create_payment_period_if_needed en lugar de 
