-- Corregir las funciones para usar la columna correcta en fuel_expenses
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- CALCULAR FUEL EXPENSES (usar total_amount, no amount)
...
-- También corregir la función recalculate_payment_period_totals
