-- Arreglar la lógica mensual para gastos recurrentes
  ...
  LOOP
    ...
    LOOP
      ...
      CASE template_record.frequency
        ...
        WHEN 'monthly' THEN
          -- Para mensual, aplicar siempre (una vez por período)
          -- Ya que cada período representa un ciclo de pago de la empresa
          should_apply := true;
      END CASE;
...
-- Probar inmediatamente con el período actual
