-- Eliminar fuel_expenses que están asociados a los períodos que vamos a borrar
...
-- Eliminar loads que están asociados a los períodos
WITH current_and_next_periods AS (
  SELECT id 
  FROM company_payment_periods 
  WHERE company_id = 'e5d52767-ca59-4c28-94e4-058aff6a037b'
