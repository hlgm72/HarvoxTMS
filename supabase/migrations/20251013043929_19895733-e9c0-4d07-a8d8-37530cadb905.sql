-- ===============================================
-- 🔄 ACTUALIZACIÓN: simple_load_operation_with_deductions v2.0
-- ===============================================
-- Corrige la asignación de períodos:
-- 1. loads.payment_period_id → company_payment_periods.id
-- 2. Cuando hay driver → crear user_payrolls (no user_payment_periods)
...
BEGIN
  ...
  IF v_relevant_date IS NOT NULL THEN
    ...
    -- Si no existe, crear uno nuevo usando la función existente
    ...
    -- 🎯 PASO 2: Si hay driver, crear/usar user_payrolls
