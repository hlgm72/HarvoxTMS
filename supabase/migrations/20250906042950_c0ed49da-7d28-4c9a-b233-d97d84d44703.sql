-- SOLUCIÓN COMPLETA: Arreglar cálculos automáticos de conductores (CORREGIDO)
...
DECLARE
  ...
  company_id UUID;
BEGIN
  -- Obtener el cálculo y datos del período
  SELECT dpc.*, cpp.period_start_date, cpp.period_end_date, cpp.company_id
  INTO calc_record, period_start_date, period_end_date, company_id
