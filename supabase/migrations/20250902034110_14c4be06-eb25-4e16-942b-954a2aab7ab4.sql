-- Fix percentage deductions to accumulate instead of replace
...
BEGIN
  ...
  IF result_load.driver_user_id IS NOT NULL THEN
    ...
    -- FIXED: Sum deductions instead of replacing them
    IF factoring_amount > 0 AND factoring_expense_type_id IS NOT NULL THEN
      ...
      DO UPDATE SET
        amount = expense_instances.amount + EXCLUDED.amount,  -- SUM instead of replace
