-- Arreglar generate_company_payment_periods_with_calculations para que calcule automáticamente los valores
-- El problema es que solo crea registros vacíos sin llamar a las funciones de cálculo
    ...
    IF run_calculations THEN
      ...
      LOOP
        ...
        IF NOT EXISTS (
          ...
          -- Create driver calculation record with initial values
          ...
          -- 🚨 FIX CRÍTICO: Llamar automáticamente a la función de cálculo
          -- para calcular los valores reales (cargas, deducciones, etc.)
