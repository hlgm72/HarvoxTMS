-- Remove all customer_rate references from database functions

-- Drop and recreate simple_load_operation_with_deductions WITHOUT customer_rate
...
BEGIN
  ...
  -- For UPDATE operations, get old payment period
  ...
  -- Create or update load (WITHOUT customer_rate column)
  ...
  ELSE
    -- UPDATE operation (WITHOUT customer_rate column)
    UPDATE loads SET
  ...
  -- Recalculate payment period if driver assigned
