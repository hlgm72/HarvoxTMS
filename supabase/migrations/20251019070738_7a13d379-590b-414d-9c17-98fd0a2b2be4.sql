-- ============================================================================
-- FIX: Incluir is_active en UPDATE de expense templates
-- ============================================================================

CREATE OR REPLACE FUNCTION public.create_or_update_expense_template_with_validation(template_data jsonb, template_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  ELSE
    ...
    -- ✅ FIX: Agregar is_active al UPDATE
