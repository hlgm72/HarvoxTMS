-- ========================================
-- 🚨 CRITICAL FIX: Deducciones por Período - Versión Final
-- ========================================

-- ========================================
-- PASO 1: Eliminar constraint si existe (para poder limpiar datos)
-- ========================================
...
-- ========================================
-- PASO 3: Volver a crear constraint único
-- ========================================
ALTER TABLE expense_instances 
...
-- ========================================
-- PASO 4: Función para generar descripción con período
-- ========================================
...
-- ========================================
-- PASO 5: Función para recalcular deducciones del período
-- ========================================
...
BEGIN
  -- Eliminar deducciones por porcentaje existentes
  ...
  -- Calcular sumas totales de TODAS las cargas del período
  SELECT
...
-- ========================================
-- PASO 6: Modificar función de carga
-- ========================================
...
BEGIN
  ...
  IF v_relevant_date IS NOT NULL THEN
    ...
    IF v_driver_user_id IS NOT NULL THEN
      ...
      -- Si cambió de período o conductor, recalcular también los anteriores
      IF v_is_update THEN
