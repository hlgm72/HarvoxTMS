-- Check if load-documents bucket exists, if not create it
INSERT INTO storage.buckets (id, name, public)
VALUES ('load-documents', 'load-documents', false)
ON CONFLICT (id) DO NOTHING;

-- Also ensure we have the create_or_update_load_document_with_validation function
...
BEGIN
  ...
  ELSE
    UPDATE load_documents SET
      ...
      file_size = NULLIF((document_data->>'file_size'), '')::BIGINT,
