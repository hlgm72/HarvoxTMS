-- Modificar función calculate_driver_payment_period para incluir cargas basándose en pickup_date y criterio de la empresa
...
BEGIN
  ...
  current_balance := total_income_amount;
...
-- Actualizar configuración de la empresa para usar pickup_date como criterio por defecto
UPDATE public.companies 
SET load_assignment_criteria = 'pickup_date'
WHERE load_assignment_criteria IS NULL OR load_assignment_criteria = 'delivery_date';