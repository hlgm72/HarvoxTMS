-- Drop ALL variations of the function to ensure clean slate
DROP FUNCTION IF EXISTS public.create_or_update_load_with_validation(jsonb, jsonb, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_or_update_load_with_validation(jsonb, jsonb) CASCADE;
DROP FUNCTION IF EXISTS create_or_update_load_with_validation(jsonb, jsonb, text) CASCADE;
