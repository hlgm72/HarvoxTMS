-- Fix owner_operators join in generate_load_percentage_deductions - no company_id column exists
...
BEGIN
  ...
  -- Fix: owner_operators doesn't have company_id, use only user_id
  SELECT 
