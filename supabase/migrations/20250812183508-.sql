-- Fix simple_load_operation function - loads table doesn't have company_id column
-- The verification should be done through created_by field instead
...
BEGIN
  ...
  IF operation_mode = 'edit' THEN
    ...
    IF NOT EXISTS (
      ...
      JOIN public.user_company_roles ucr ON l.created_by = ucr.user_id
  ...
  RAISE LOG 'simple_load_operation completed successfully: %', result_data;
