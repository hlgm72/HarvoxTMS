...
-- Check if document_type enum exists and create if needed
DO $$ 
BEGIN
...
-- Create the load document validation function
CREATE FUNCTION create_or_update_load_document_with_validation(
    document_data jsonb,
