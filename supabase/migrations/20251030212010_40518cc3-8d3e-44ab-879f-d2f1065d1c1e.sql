-- Corregir referencia incorrecta a user_roles en simple_load_operation_with_deductions
-- La tabla correcta es user_company_roles
...
BEGIN
  ...
  -- Obtener company_id desde user_company_roles (CORREGIDO: era user_roles)
