-- Fix automatic deduction titles to use simple English format
CREATE OR REPLACE FUNCTION public.create_percentage_deductions_for_load(
  ...
  leasing_pct_param numeric DEFAULT 0,
  factoring_pct_param numeric DEFAULT 0,
  dispatching_pct_param numeric DEFAULT 0,
