-- Update only the problematic RLS policies to properly block anonymous users
-- Without dropping the existing security functions

-- Update expense_recurring_templates policies to be more restrictive
...
-- Update other_income policies to be more restrictive
