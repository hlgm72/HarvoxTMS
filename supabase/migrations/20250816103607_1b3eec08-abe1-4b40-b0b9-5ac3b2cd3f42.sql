...
-- Drop all views completely and recreate them properly
...
-- Recreate companies_public view WITHOUT SECURITY DEFINER
...
-- Recreate companies_financial view WITHOUT SECURITY DEFINER
...
-- Recreate equipment_status_summary view WITHOUT SECURITY DEFINER
