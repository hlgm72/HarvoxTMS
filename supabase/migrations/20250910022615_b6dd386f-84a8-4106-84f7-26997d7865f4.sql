-- Fix all ambiguous load_id references in the function
-- Use explicit parameter names and table prefixes
...
DECLARE
  ...
  calculation_id UUID;
  calc_result JSONB;
  input_load_id UUID := load_id; -- Use explicit variable for parameter
BEGIN
