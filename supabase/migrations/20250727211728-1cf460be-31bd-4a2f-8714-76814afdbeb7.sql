-- Now create the SECURITY DEFINER functions and new policies without recursion

-- Function to check if user has specific role in any company
...
-- Policy for company owners to manage roles (INSERT, UPDATE, DELETE)
