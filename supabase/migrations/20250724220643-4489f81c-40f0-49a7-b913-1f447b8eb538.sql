-- =====================================================
-- MIGRACIÓN: Sistema de Deducciones - Tablas Principales
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.recurring_expense_templates (
  ...
  CONSTRAINT unique_active_template_per_driver_type UNIQUE (driver_user_id, expense_type_id, frequency) DEFERRABLE INITIALLY DEFERRED
);
...
CREATE INDEX idx_recurring_templates_company_active ON public.recurring_expense_templates(company_id, is_active);
...
-- 11. Actualizar función updated_at
