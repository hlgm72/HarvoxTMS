-- ============================================================================
-- 🔧 CORRECCIÓN CRÍTICA: Arreglar estructura de datos para cálculo correcto
-- ============================================================================
...
BEGIN
  -- Log de inicio
  RAISE NOTICE '🔄 v3.1-ESTRUCTURA-FIJA: Iniciando recálculo para conductor % en período %', target_driver_user_id, target_period_id;
  ...
  SELECT id INTO company_period_id
  ...
  RAISE NOTICE '✅ v3.1-ESTRUCTURA-FIJA: Recálculo completado correctamente para conductor %', target_driver_user_id;
...
EXCEPTION WHEN OTHERS THEN
  RAISE EXCEPTION 'ERROR_OPERATION_FAILED: Error en recálculo v3.1-ESTRUCTURA-FIJA: %', SQLERRM;
END;
$$;