-- ============================================================================
-- CORRECCIÓN: Eliminar referencia a has_negative_balance que no existe
-- ============================================================================
...
BEGIN
  ...
  IF v_driver_user_id IS NOT NULL AND v_company_payment_period_id IS NOT NULL THEN
    ...
    IF v_user_payroll_id IS NULL THEN
      -- ✅ CORREGIDO: Eliminar has_negative_balance que no existe
      INSERT INTO user_payrolls (
        ...
        net_payment, payment_status, calculated_by
      ) VALUES (
...
EXCEPTION WHEN OTHERS THEN
  RETURN jsonb_build_object('success', false, 'error', 'ERROR_OPERATION_FAILED: ' || SQLERRM);
END;
$$;