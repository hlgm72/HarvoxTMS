-- Align gross earnings calculation with percentage deductions generator
-- Include the same load statuses used in generate_load_percentage_deductions
...
BEGIN
    ...
    -- 2) Gross earnings from loads in the period (align statuses with generator)
