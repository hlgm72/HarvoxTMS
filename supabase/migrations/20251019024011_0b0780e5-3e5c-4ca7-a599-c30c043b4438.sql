-- ============================================================================
-- CORRECCIÓN: fuel_expenses debe usar company_payment_period_id
-- ============================================================================
...
DECLARE
  ...
  v_payment_period_id uuid; -- Este es user_payroll_id
  v_company_payment_period_id uuid; -- Este es el que necesitamos para fuel_expenses
...
BEGIN
  ...
  -- Si payment_period_id existe, obtener el company_payment_period_id
  ...
  -- Recalcular usando company_payment_period_id
...
EXCEPTION WHEN OTHERS THEN
  RETURN jsonb_build_object(
    'success', false,
    'message', 'ERROR_OPERATION_FAILED: ' || SQLERRM
  );
END;
$function$;