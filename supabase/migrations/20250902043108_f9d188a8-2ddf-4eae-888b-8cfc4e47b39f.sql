-- Fix duplicate expense instance creation in create_payment_period_if_needed
-- The function was not properly checking for existing expense instances including user_id
...
BEGIN
  ...
  IF period_id IS NULL THEN
    ...
    LOOP
      ...
      LOOP
        -- FIXED: Check for existing expense instance including user_id to match unique constraint
