-- Crear función optimizada para verificar acceso de usuario de empresa
CREATE OR REPLACE FUNCTION public.is_authenticated_company_user()
RETURNS boolean
LANGUAGE sql
...
-- Optimizar todas las políticas problemáticas usando la función
