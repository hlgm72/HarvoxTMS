-- ====================================================================
-- 🔧 CORRECCIÓN FINAL: Pasar el ID correcto a recalculate_period_percentage_deductions
-- ====================================================================
-- 
-- PROBLEMA REAL IDENTIFICADO:
-- La función recalculate_period_percentage_deductions espera company_payment_period_id
-- pero simple_load_operation_with_deductions estaba pasando user_payroll_id
-- 
-- Esto causaba el error de FK porque expense_instances.payment_period_id 
-- debe ser un company_payment_periods.id válido, no un user_payrolls.id
-- ====================================================================
...
BEGIN
  ...
  IF v_relevant_date IS NOT NULL THEN
    ...
    IF v_driver_user_id IS NOT NULL THEN
      ...
      -- ✅ CORRECCIÓN: Pasar company_payment_period_id en lugar de user_payroll_id
      BEGIN
...
COMMENT ON FUNCTION simple_load_operation_with_deductions IS 'FIXED: Now correctly passes company_payment_period_id to recalculate_period_percentage_deductions instead of user_payroll_id. This prevents FK violations in expense_instances table.';