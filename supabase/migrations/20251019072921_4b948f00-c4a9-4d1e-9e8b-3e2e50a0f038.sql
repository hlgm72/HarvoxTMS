-- ============================================================================
-- FIX ABSOLUTO: Usar alias de tabla explícito para evitar ambigüedad RLS
-- ============================================================================
...
BEGIN
  ...
  ELSE
    ...
    -- ✅ Usar alias de tabla explícito para evitar ambigüedad con políticas RLS
    SELECT ert.amount, ert.is_active 
    ...
    UPDATE expense_recurring_templates ert SET
