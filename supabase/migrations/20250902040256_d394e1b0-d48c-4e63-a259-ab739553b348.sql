-- Drop and recreate the create_payment_period_if_needed function to fix duplicate expense instances
...
BEGIN
  ...
  IF period_id IS NULL THEN
    ...
    LOOP
      ...
      -- Generate recurring expense instances for this driver (FIXED: Check for duplicates)
      ...
      LOOP
        ...
        ELSE
          RAISE LOG 'create_payment_period_if_needed: Skipped duplicate expense % for driver %', 
            recurring_expense.expense_type_id, driver_record.user_id;
        END IF;
      END LOOP;
    END LOOP;
