-- ============================================================================
-- SOLUCIÓN DEFINITIVA: Deshabilitar trigger durante UPDATE para evitar conflicto
-- ============================================================================
...
BEGIN
  ...
  ELSE
    ...
    INTO old_amount, previous_is_active
    ...
    -- ✅ Deshabilitar trigger temporalmente durante UPDATE
    ...
    -- ✅ Reactivar trigger
    ALTER TABLE expense_recurring_templates ENABLE TRIGGER trigger_sync_recurring_template_on_update;
    
    -- ✅ Ejecutar manualmente la lógica del trigger
    PERFORM apply_recurring_expenses_to_user_payroll(
      target_user_id,
      (SELECT company_payment_period_id FROM user_payrolls 
...
EXCEPTION WHEN OTHERS THEN
  -- ✅ Asegurar que el trigger se reactive incluso si hay error
  ALTER TABLE expense_recurring_templates ENABLE TRIGGER trigger_sync_recurring_template_on_update;
