-- Intentar una eliminación forzada y recreación completa
-- Primero verificar qué vistas existen actualmente
DO $$
BEGIN
  -- Eliminar todas las vistas relacionadas
  ...
  -- Recrear las vistas sin ninguna propiedad especial
