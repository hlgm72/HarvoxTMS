-- Fix ambiguous column references in multiple functions
-- 1. Fix calculate_driver_payment_period function
...
BEGIN
    ...
    -- PASO 2: Calcular ingresos brutos de cargas completadas (con alias)
    ...
    -- PASO 4: Calcular gastos de combustible (con alias)
    ...
    -- PASO 5: Calcular total de deducciones (con alias)
    ...
    -- PASO 6: Calcular otros ingresos (con alias)
