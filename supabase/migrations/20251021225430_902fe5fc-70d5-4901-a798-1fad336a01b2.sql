-- ===============================================
-- FIX: Update RPC to use correct table name
-- ===============================================

-- Drop the old function
DROP FUNCTION IF EXISTS public.mark_driver_as_paid_with_validation(UUID, TEXT, TEXT, TEXT);

-- Recreate with correct table name (user_payrolls instead of driver_period_calculations)
...
BEGIN
  ...
  SELECT up.*, cpp.company_id, cpp.is_locked, cpp.status as period_status
