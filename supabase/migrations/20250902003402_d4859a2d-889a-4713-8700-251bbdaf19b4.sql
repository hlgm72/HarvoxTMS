-- Corregir la lógica de estado en simple_load_operation
-- El estado debe ser 'unassigned' si no hay conductor, 'assigned' si hay conductor
...
BEGIN
  ...
  ELSE
    -- UPDATE operation - also update status logic
    UPDATE loads SET
