-- Actualizar mark_multiple_drivers_as_paid_with_validation para preservar net_payment
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- PASO 2: Marcar payroll como paid Y RESTAURAR net_payment original
...
COMMENT ON FUNCTION mark_multiple_drivers_as_paid_with_validation IS 
  '🔥 CRÍTICO: Preserva el valor original de net_payment para cada payroll durante el pago masivo.';
