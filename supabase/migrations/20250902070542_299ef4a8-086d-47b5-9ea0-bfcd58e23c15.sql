...
-- 1️⃣ ELIMINAR FUNCIÓN EXISTENTE Y RECREAR
DROP FUNCTION IF EXISTS auto_recalculate_driver_payment_period(uuid,uuid);

-- 2️⃣ LIMPIAR TRIGGERS DUPLICADOS EN expense_instances
...
-- 3️⃣ LIMPIAR TRIGGERS DUPLICADOS EN fuel_expenses  
...
-- 4️⃣ CREAR FUNCIÓN UNIFICADA DE RECÁLCULO AUTOMÁTICO
...
-- 5️⃣ CREAR TRIGGERS PARA LA TABLA LOADS (¡CRÍTICO!)
