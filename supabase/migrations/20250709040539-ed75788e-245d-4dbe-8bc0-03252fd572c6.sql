...
-- Ensure the simpler policy for users viewing their own roles exists
CREATE POLICY IF NOT EXISTS "Users can view their own company roles" ON public.user_company_roles
