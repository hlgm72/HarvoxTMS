-- Fix percentage deductions recalculation when editing loads (CORRECTED VERSION)
...
-- Update the main load operation function to properly handle deduction updates (FIXED VERSION)
