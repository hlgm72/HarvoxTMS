-- Corregir mark_driver_as_paid_with_validation para actualizar TODAS las entidades
-- Orden crítico: loads, fuel, other_income, expense_instances PRIMERO
-- Luego marcar el payroll como paid para evitar triggers de inmutabilidad
